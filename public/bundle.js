...
class Main extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  componentDidMount() {
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/api/products").then(products => this.setState({ products })).then(() => console.log(this.state.products)).catch(e => this.setState({ errorMessage: e.message }));
  }
  render() {
